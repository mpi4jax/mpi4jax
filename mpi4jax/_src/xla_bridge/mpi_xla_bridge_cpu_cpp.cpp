...
static void mpi_barrier_cpu_legacy(void** out_ptr, void** data_ptr) {
    MPI_Comm comm = reinterpret_cast<MPI_Comm>(*reinterpret_cast<uintptr_t*>(data_ptr[0]));
    mpi_barrier(comm);
}

static void mpi_allgather_cpu_legacy(void** out_ptr, void** data_ptr) {
    int sendcount = *reinterpret_cast<int*>(data_ptr[0]);
    void* sendbuf = data_ptr[1];
    MPI_Datatype sendtype = reinterpret_cast<MPI_Datatype>(*reinterpret_cast<uintptr_t*>(data_ptr[2]));
    int recvcount = *reinterpret_cast<int*>(data_ptr[3]);
    MPI_Datatype recvtype = reinterpret_cast<MPI_Datatype>(*reinterpret_cast<uintptr_t*>(data_ptr[4]));
    MPI_Comm comm = reinterpret_cast<MPI_Comm>(*reinterpret_cast<uintptr_t*>(data_ptr[5]));

    void* recvbuf = out_ptr[0];
    mpi_allgather(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, comm);
}

static void mpi_allreduce_cpu_legacy(void** out_ptr, void** data_ptr) {
    int nitems = *reinterpret_cast<int*>(data_ptr[0]);
    void* sendbuf = data_ptr[1];
    MPI_Op op = reinterpret_cast<MPI_Op>(*reinterpret_cast<uintptr_t*>(data_ptr[2]));
    MPI_Comm comm = reinterpret_cast<MPI_Comm>(*reinterpret_cast<uintptr_t*>(data_ptr[3]));
    MPI_Datatype dtype = reinterpret_cast<MPI_Datatype>(*reinterpret_cast<uintptr_t*>(data_ptr[4]));

    void* recvbuf = out_ptr[0];
    mpi_allreduce(sendbuf, recvbuf, nitems, dtype, op, comm);
}

static void mpi_alltoall_cpu_legacy(void** out_ptr, void** data_ptr) {
    int sendcount = *reinterpret_cast<int*>(data_ptr[0]);
    void* sendbuf = data_ptr[1];
    MPI_Datatype sendtype = reinterpret_cast<MPI_Datatype>(*reinterpret_cast<uintptr_t*>(data_ptr[2]));
    int recvcount = *reinterpret_cast<int*>(data_ptr[3]);
...
static void mpi_bcast_cpu_legacy(void** out_ptr, void** data_ptr) {
    int nitems = *reinterpret_cast<int*>(data_ptr[0]);
    void* sendbuf = data_ptr[1];
    int root = *reinterpret_cast<int*>(data_ptr[2]);
    MPI_Comm comm = reinterpret_cast<MPI_Comm>(*reinterpret_cast<uintptr_t*>(data_ptr[3]));
    MPI_Datatype dtype = reinterpret_cast<MPI_Datatype>(*reinterpret_cast<uintptr_t*>(data_ptr[4]));
    ...
    void* buf = (rank == root) ? sendbuf : recvbuf;
    mpi_bcast(buf, nitems, dtype, root, comm);
}

static void mpi_gather_cpu_legacy(void** out_ptr, void** data_ptr) {
    int sendcount = *reinterpret_cast<int*>(data_ptr[0]);
    void* sendbuf = data_ptr[1];
    MPI_Datatype sendtype = reinterpret_cast<MPI_Datatype>(*reinterpret_cast<uintptr_t*>(data_ptr[2]));
    int recvcount = *reinterpret_cast<int*>(data_ptr[3]);
    MPI_Datatype recvtype = reinterpret_cast<MPI_Datatype>(*reinterpret_cast<uintptr_t*>(data_ptr[4]));
    int root = *reinterpret_cast<int*>(data_ptr[5]);
    MPI_Comm comm = reinterpret_cast<MPI_Comm>(*reinterpret_cast<uintptr_t*>(data_ptr[6]));

    void* recvbuf = out_ptr[0];
    mpi_gather(sendbuf, sendcount, sendtype, recvbuf, recvcount, recvtype, root, comm);
}

static void mpi_scatter_cpu_legacy(void** out_ptr, void** data_ptr) {
    int sendcount = *reinterpret_cast<int*>(data_ptr[0]);
    void* sendbuf = data_ptr[1];
    MPI_Datatype sendtype = reinterpret_cast<MPI_Datatype>(*reinterpret_cast<uintptr_t*>(data_ptr[2]));
    int recvcount = *reinterpret_cast<int*>(data_ptr[3]);
...
static void mpi_reduce_cpu_legacy(void** out_ptr, void** data_ptr) {
    int nitems = *reinterpret_cast<int*>(data_ptr[0]);
    void* sendbuf = data_ptr[1];
    MPI_Op op = reinterpret_cast<MPI_Op>(*reinterpret_cast<uintptr_t*>(data_ptr[2]));
    int root = *reinterpret_cast<int*>(data_ptr[3]);
    MPI_Comm comm = reinterpret_cast<MPI_Comm>(*reinterpret_cast<uintptr_t*>(data_ptr[4]));
    MPI_Datatype dtype = reinterpret_cast<MPI_Datatype>(*reinterpret_cast<uintptr_t*>(data_ptr[5]));

    void* recvbuf = out_ptr[0];
    mpi_reduce(sendbuf, recvbuf, nitems, dtype, op, root, comm);
}

static void mpi_scan_cpu_legacy(void** out_ptr, void** data_ptr) {
    int nitems = *reinterpret_cast<int*>(data_ptr[0]);
    void* sendbuf = data_ptr[1];
    MPI_Op op = reinterpret_cast<MPI_Op>(*reinterpret_cast<uintptr_t*>(data_ptr[2]));
    MPI_Comm comm = reinterpret_cast<MPI_Comm>(*reinterpret_cast<uintptr_t*>(data_ptr[3]));
    ...
    void* recvbuf = out_ptr[0];
    mpi_scan(sendbuf, recvbuf, nitems, dtype, op, comm);
}

static void mpi_send_cpu_legacy(void** out_ptr, void** data_ptr) {
    int nitems = *reinterpret_cast<int*>(data_ptr[0]);
    void* sendbuf = data_ptr[1];
    int dest = *reinterpret_cast<int*>(data_ptr[2]);
    int tag = *reinterpret_cast<int*>(data_ptr[3]);
    MPI_Comm comm = reinterpret_cast<MPI_Comm>(*reinterpret_cast<uintptr_t*>(data_ptr[4]));
    MPI_Datatype dtype = reinterpret_cast<MPI_Datatype>(*reinterpret_cast<uintptr_t*>(data_ptr[5]));

    mpi_send(sendbuf, nitems, dtype, dest, tag, comm);
}

static void mpi_recv_cpu_legacy(void** out_ptr, void** data_ptr) {
    int nitems = *reinterpret_cast<int*>(data_ptr[0]);
    int source = *reinterpret_cast<int*>(data_ptr[1]);
    int tag = *reinterpret_cast<int*>(data_ptr[2]);
    MPI_Comm comm = reinterpret_cast<MPI_Comm>(*reinterpret_cast<uintptr_t*>(data_ptr[3]));
    MPI_Datatype dtype = reinterpret_cast<MPI_Datatype>(*reinterpret_cast<uintptr_t*>(data_ptr[4]));
    MPI_Status* status = reinterpret_cast<MPI_Status*>(*reinterpret_cast<uintptr_t*>(data_ptr[5]));

    void* recvbuf = out_ptr[0];
    mpi_recv(recvbuf, nitems, dtype, source, tag, comm, status);
}
...
PYBIND11_MODULE(mpi_xla_bridge_cpu_cpp, m) {
    ...
    custom_call_targets["mpi_barrier"] = make_legacy_capsule(reinterpret_cast<void*>(&mpi_barrier_cpu_legacy));
    custom_call_targets["mpi_allgather"] = make_legacy_capsule(reinterpret_cast<void*>(&mpi_allgather_cpu_legacy));
    custom_call_targets["mpi_allreduce"] = make_legacy_capsule(reinterpret_cast<void*>(&mpi_allreduce_cpu_legacy));
    custom_call_targets["mpi_alltoall"] = make_legacy_capsule(reinterpret_cast<void*>(&mpi_alltoall_cpu_legacy));
    custom_call_targets["mpi_bcast"] = make_legacy_capsule(reinterpret_cast<void*>(&mpi_bcast_cpu_legacy));
    custom_call_targets["mpi_gather"] = make_legacy_capsule(reinterpret_cast<void*>(&mpi_gather_cpu_legacy));
    custom_call_targets["mpi_scatter"] = make_legacy_capsule(reinterpret_cast<void*>(&mpi_scatter_cpu_legacy));
    custom_call_targets["mpi_reduce"] = make_legacy_capsule(reinterpret_cast<void*>(&mpi_reduce_cpu_legacy));
    custom_call_targets["mpi_scan"] = make_legacy_capsule(reinterpret_cast<void*>(&mpi_scan_cpu_legacy));
    custom_call_targets["mpi_send"] = make_legacy_capsule(reinterpret_cast<void*>(&mpi_send_cpu_legacy));
    custom_call_targets["mpi_recv"] = make_legacy_capsule(reinterpret_cast<void*>(&mpi_recv_cpu_legacy));
    custom_call_targets["mpi_sendrecv"] = make_legacy_capsule(reinterpret_cast<void*>(&mpi_sendrecv_cpu_legacy));
