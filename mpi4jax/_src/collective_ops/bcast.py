...
def mpi_bcast_xla_encode_gpu_cuda(ctx, x, token, root, comm):
    from ..xla_bridge.mpi_xla_bridge_gpu_cuda import build_bcast_descriptor
...
mlir.register_lowering(mpi_bcast_p, mpi_bcast_xla_encode_gpu_cuda, platform="cuda")
