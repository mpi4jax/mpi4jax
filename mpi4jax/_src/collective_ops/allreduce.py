...
def mpi_allreduce_xla_encode_gpu_cuda(ctx, x, token, op, comm, transpose):
    from ..xla_bridge.mpi_xla_bridge_gpu_cuda import build_allreduce_descriptor
...
mlir.register_lowering(
    mpi_allreduce_p, mpi_allreduce_xla_encode_gpu_cuda, platform="cuda"
)
mlir.register_lowering(
