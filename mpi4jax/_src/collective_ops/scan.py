...
def mpi_scan_xla_encode_gpu_cuda(ctx, x, token, op, comm):
    from ..xla_bridge.mpi_xla_bridge_gpu_cuda import build_scan_descriptor
...
@translation_rule_gpu
def mpi_scan_xla_encode_gpu_hip(ctx, x, token, op, comm):
    from ..xla_bridge.mpi_xla_bridge_gpu_hip import build_scan_descriptor
...
mlir.register_lowering(mpi_scan_p, mpi_scan_xla_encode_gpu_cuda, platform="cuda")
mlir.register_lowering(mpi_scan_p, mpi_scan_xla_encode_gpu_hip, platform="rocm")
