...
def mpi_scan_xla_encode_hip(ctx, x, token, op, comm):
    from ..xla_bridge.mpi_xla_bridge_hip import build_scan_descriptor
...
mlir.register_lowering(mpi_scan_p, mpi_scan_xla_encode_hip, platform="rocm")
