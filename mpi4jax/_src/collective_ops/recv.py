...
def mpi_recv_xla_encode_gpu_cuda(ctx, x, token, source, tag, comm, status):
    from ..xla_bridge.mpi_xla_bridge import MPI_STATUS_IGNORE_ADDR
    from ..xla_bridge.mpi_xla_bridge_gpu_cuda import build_recv_descriptor
...
mlir.register_lowering(mpi_recv_p, mpi_recv_xla_encode_gpu_cuda, platform="cuda")
