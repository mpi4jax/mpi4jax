...
def mpi_send_xla_encode_hip(ctx, x, token, dest, tag, comm):
    from ..xla_bridge.mpi_xla_bridge_hip import build_send_descriptor
...
mlir.register_lowering(mpi_send_p, mpi_send_xla_encode_hip, platform="rocm")
