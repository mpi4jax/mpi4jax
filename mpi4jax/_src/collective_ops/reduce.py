...
def mpi_reduce_xla_encode_gpu_cuda(ctx, x, token, op, root, comm):
    from ..xla_bridge.mpi_xla_bridge_gpu_cuda import build_reduce_descriptor
...
mlir.register_lowering(mpi_reduce_p, mpi_reduce_xla_encode_gpu_cuda, platform="cuda")
