...
def mpi_allgather_xla_encode_gpu_cuda(ctx, sendbuf, token, comm):
    from ..xla_bridge.mpi_xla_bridge_gpu_cuda import build_allgather_descriptor
...
mlir.register_lowering(
    mpi_allgather_p, mpi_allgather_xla_encode_gpu_cuda, platform="cuda"
)
mlir.register_lowering(
